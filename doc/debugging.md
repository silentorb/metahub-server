...
&& !(this instanceof java.security.AccessControlException)
...
&& !(this instanceof java.lang.IllegalArgumentException)
...
&& !(this instanceof java.util.concurrent.CancellationException)
```
